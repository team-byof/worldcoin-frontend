...
export async function callExactInputSingle(
  ...
  const cred = {
    merkle_root: BigNumber.from("21651615895955828151852809722783968631497059613185788632496826434461907998126"),
    group: BigNumber.from("1"),
    signal: "my_signal",
    nullifier_hash: BigNumber.from("6728982073551526785722952266936853582119478438086215932478760190917718952680"),
    app_id: "app_5bf8fcd0369d5ac0ec85529e347b5d57",
    action: "test_2",
    proof: [
      BigNumber.from("2333333733273306321795567365140581065672082323104646785305898632316171833013"),
      BigNumber.from("5875327076857389847128448536109815438269429571993340134280193209652596596397"),
      BigNumber.from("9106708784576333189079679655038633754829918750642832708423659586049166856705"),
      BigNumber.from("19322322736555249354894479029874230118337796974345692395729723741384989124824"),
      BigNumber.from("15295043829978438530774756459723211257521998509377547480388973668481728868989"),
      BigNumber.from("8326951365504379002512535735692255267639097398089148187494423941235589693195"),
      BigNumber.from("8909247863636284552005463819141545643760988818720908876848215937057730927654"),
      BigNumber.from("2175797585662931625218291133743597373136042265748485647914138129379943746143")
    ],
  };
